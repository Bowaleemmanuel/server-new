...
//   }, [navigate, redirect, userInfo]);
  ...
  return (
    <div className="flex flex-row ">
      ...
      <div>
        <img
          src="https://www.jotform.com/uploads/owobocollections/form_files/IMG_6116.671d47ca2970a6.06075962.jpeg"
          alt="shop"
          className="h-60px w-full xl:block md:hidden rounded-lg mt-4rem"
        />
      </div>
    </div>
  );
